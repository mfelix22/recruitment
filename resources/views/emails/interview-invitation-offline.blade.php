...
<body>
    <div class="container">
        <div class="header">
            <h2 style="margin:0">Undangan Interview Offline</h2>
        </div>
        <div class="body">
            ...
            <p>Mohon hadir tepat waktu dan membawa dokumen identitas diri. Jika ada pertanyaan atau kendala, silakan hubungi kami melalui email ini.</p>
